...
<p>新規予定作成
    <table>
        <tr>
            <th>予定名称</th>
            <td><input type="text" class="form-control" name="event_name" value="<?php echo $event_name; ?>" /></td>
        </tr>
        <tr>
            <th>予定日</th>
            <td><input type="date" class="form-control" name="event_date" value="<?php echo $event_date; ?>" /></td>
        </tr>
        <tr>
            <th>終日</th>
        ...
        <tr>
            <th>開始時刻</th>
            <td><input type="time" class="form-control" name="event_start_time" value="<?php echo $event_start_time; ?>" /></td>
        </tr>
        <tr>
            <th>終了時刻</th>
            <td><input type="time" class="form-control" name="event_end_time" value="<?php echo $event_end_time; ?>" /></td>
        </tr>
        <tr>
            <th>ユーザ</th>
